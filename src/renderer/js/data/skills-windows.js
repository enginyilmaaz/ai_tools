window.SkillCatalogWindows = [
    { id: 'analyze', icon: 'analytics', category: 'general', requirement: 'universal', order: 10, nameKey: 'SkillNameAnalyze', descKey: 'SkillDescAnalyze' },
    { id: 'code-review', icon: 'rate_review', category: 'general', requirement: 'universal', order: 20, nameKey: 'SkillNameCodeReview', descKey: 'SkillDescCodeReview' },
    ...
    { id: 'jira-api', icon: 'assignment', category: 'general', requirement: 'universal', order: 50, nameKey: 'SkillNameJiraApi', descKey: 'SkillDescJiraApi' },
    ...
    { id: 'playwright', icon: 'play_circle', category: 'general', requirement: 'universal', order: 70, nameKey: 'SkillNamePlaywright', descKey: 'SkillDescPlaywright' },
