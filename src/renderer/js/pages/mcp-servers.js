...
window.McpServersPage = {
    ...
    _allIntegrations: [
        ...
        { id: 'claude-code-setup', icon: 'assets/mcp/claude-code-setup.svg', nameKey: 'PluginClaudeCodeSetupName', descKey: 'PluginClaudeCodeSetupDesc', type: 'plugin' },
        { id: 'claude-security', icon: 'assets/mcp/claude-security.svg', nameKey: 'PluginClaudeSecurityName', descKey: 'PluginClaudeSecurityDesc', type: 'plugin' },
        { id: 'skill-creator', icon: 'assets/mcp/skill-creator.svg', nameKey: 'PluginSkillCreatorName', descKey: 'PluginSkillCreatorDesc', type: 'plugin' },
