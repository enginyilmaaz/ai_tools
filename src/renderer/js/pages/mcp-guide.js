...
window.McpGuidePage = {
    ...
    _chapterDefs: [
        ...
        { id: 'claude-code-setup', icon: 'settings_suggest' },
        { id: 'claude-security', icon: 'shield' },
        { id: 'skill-creator', icon: 'auto_fix_high' },
    ...
    _i18n: {
        en: {
            ...
            'claude-code-setup': { title: 'Claude Code Setup Plugin', body: '<p><strong>Claude Code Setup</strong> analyzes your codebase and recommends tailored Claude Code automations — hooks, skills, MCP servers, and subagents — configured for your project.</p><h3>What Can You Do?</h3><ul><li>Scan a repo and get a setup plan</li><li>Recommend hooks, skills and subagents that fit your stack</li><li>Bootstrap the automations it suggests</li></ul><h3>Installation</h3><pre><code>claude plugin install claude-code-setup@claude-plugins-official</code></pre><h3>Reference</h3><p><a href="https://claude.com/plugins/claude-code-setup" target="_blank">Claude Code Setup Page</a></p>', otherLang: 'Türkçe', otherLangHtml: 'Kod tabanını analiz eder; projene özel hook, skill, MCP sunucu ve subagent önerir ve kurar.' },
            'claude-security': { title: 'Claude Security Plugin', body: '<p><strong>Claude Security</strong> runs deep vulnerability scanning of your own code entirely inside your Claude Code session at a chosen effort tier. Every finding is challenged before it is reported, then turned into targeted patches, each verified by a panel of agents.</p><h3>What Can You Do?</h3><ul><li>Scan your code for vulnerabilities at a chosen effort tier</li><li>Challenge every finding before reporting for fewer false positives</li><li>Turn surviving findings into verified, targeted patches</li></ul><h3>Installation</h3><pre><code>claude plugin install claude-security@claude-plugins-official</code></pre><h3>Reference</h3><p><a href="https://claude.com/plugins/claude-security" target="_blank">Claude Security Page</a></p>', otherLang: 'Türkçe', otherLangHtml: 'Kendi kodunu seçtiğin efor seviyesinde derin tarar; her bulgu sınanır, doğrulanmış yamalara dönüşür.' },
            'skill-creator': { title: 'Skill Creator Plugin', body: '<p><strong>Skill Creator</strong> helps you create new skills, improve existing ones, and measure skill performance — scaffold from scratch, optimize, and run evals with variance analysis.</p><h3>What Can You Do?</h3><ul><li>Create a new skill from scratch</li><li>Update or optimize an existing skill</li><li>Run evals and benchmark skill performance</li></ul><h3>Installation</h3><pre><code>claude plugin install skill-creator@claude-plugins-official</code></pre><h3>Reference</h3><p><a href="https://claude.com/plugins/skill-creator" target="_blank">Skill Creator Page</a></p>', otherLang: 'Türkçe', otherLangHtml: 'Yeni skill oluştur, mevcutları iyileştir, eval ile performansı ölç.' },
        ...
        tr: {
            ...
            'claude-code-setup': { title: 'Claude Code Kurulum Eklentisi', body: '<p><strong>Claude Code Setup</strong> kod tabanını analiz eder ve projene özel Claude Code otomasyonları önerir — hook, skill, MCP sunucu ve subagent kurar.</p><h3>Neler Yapabilirsiniz?</h3><ul><li>Repoyu tarayıp kurulum planı al</li><li>Stack uyumlu hook, skill ve subagent önerileri</li><li>Önerilen otomasyonları kur</li></ul><h3>Kurulum</h3><pre><code>claude plugin install claude-code-setup@claude-plugins-official</code></pre><h3>Referans</h3><p><a href="https://claude.com/plugins/claude-code-setup" target="_blank">Claude Code Setup Sayfası</a></p>', otherLang: 'English', otherLangHtml: 'Analyzes your codebase and recommends tailored hooks, skills, MCP servers and subagents.' },
            'claude-security': { title: 'Claude Security Eklentisi', body: '<p><strong>Claude Security</strong> kendi kodunu tamamen Claude Code oturumu içinde, seçtiğin efor seviyesinde derin güvenlik taramasından geçirir. Her bulgu raporlanmadan önce sınanır, ardından her biri bir ajan paneli tarafından doğrulanan hedefli yamalara dönüştürülür.</p><h3>Neler Yapabilirsiniz?</h3><ul><li>Kodunu seçtiğin efor seviyesinde güvenlik açıklarına karşı tara</li><li>Her bulguyu raporlamadan önce sına, daha az false positive</li><li>Kalan bulguları doğrulanmış hedefli yamalara dönüştür</li></ul><h3>Kurulum</h3><pre><code>claude plugin install claude-security@claude-plugins-official</code></pre><h3>Referans</h3><p><a href="https://claude.com/plugins/claude-security" target="_blank">Claude Security Sayfası</a></p>', otherLang: 'English', otherLangHtml: 'Deep vulnerability scanning of your own code inside Claude Code, every finding verified.' },
            'skill-creator': { title: 'Skill Creator Eklentisi', body: '<p><strong>Skill Creator</strong> yeni skill oluşturmana, mevcutları iyileştirmene ve skill performansını ölçmene yardım eder — sıfırdan iskele, optimizasyon ve varyans analizli değerlendirmeler.</p><h3>Neler Yapabilirsiniz?</h3><ul><li>Sıfırdan yeni skill oluştur</li><li>Mevcut bir skill güncelle veya optimize et</li><li>Eval çalıştır, skill performansını kıyasla</li></ul><h3>Kurulum</h3><pre><code>claude plugin install skill-creator@claude-plugins-official</code></pre><h3>Referans</h3><p><a href="https://claude.com/plugins/skill-creator" target="_blank">Skill Creator Sayfası</a></p>', otherLang: 'English', otherLangHtml: 'Create, improve and evaluate skills — scaffold, optimize and benchmark.' },
