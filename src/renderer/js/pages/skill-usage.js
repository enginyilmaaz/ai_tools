...
window.SkillUsagePage = {
    ...
    _skillDefs: [
        ...
        { id: 'coding-conventions', icon: 'rule', invocation: '/coding-conventions [code task or file]', examples: ['"write new code"', '"add a function"', '"kod yaz"', '"yeni dosya olustur"', '"feature yaz"'] },
    ...
    _i18n: {
        en: {
            ...
            'coding-conventions': { subtitle: 'Proactive Coding Standards', description: 'Applies coding standards while writing code — naming, new-file placement, readability, modularity, SOLID, design patterns, max file/line size, and English comments. The proactive twin of code-review.', triggers: ['Writing new code or creating a file', 'Adding a function, class, endpoint, or component', 'Implementing a feature or refactoring'], autoTrigger: 'Auto-detected on phrases like "kod yaz", "yeni dosya olustur", "fonksiyon ekle", "feature yaz".' },
        ...
        tr: {
            ...
            'coding-conventions': { subtitle: 'Proaktif Kodlama Standartları', description: 'Kod yazarken kodlama standartlarını uygular — isimlendirme, yeni dosya yerleşimi, okunabilirlik, modülerlik, SOLID, tasarım desenleri, maksimum dosya/satır boyutu ve İngilizce yorumlar. Code-review\'ın proaktif ikizi.', triggers: ['Yeni kod yazma veya dosya oluşturma', 'Fonksiyon, class, endpoint veya component ekleme', 'Feature geliştirme veya refactoring'], autoTrigger: '"kod yaz", "yeni dosya olustur", "fonksiyon ekle", "feature yaz" gibi ifadelerde otomatik algılanır.' },
